...
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool DebugPrintSpeedDebugPrintSpeed;
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    bool FindOrthogonalFlyingPointFromTarget(const FVector& Origin, const FVector& Target, float maxSampleDistance, float idealTargetDistance, FVector& outPos);
