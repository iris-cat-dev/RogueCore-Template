...
#include "GeneratorItemWithCharges.generated.h"

class UCapacityHoldingItemAggregator;
class UDialogDataAsset;

UCLASS(Blueprintable)
class AGeneratorItemWithCharges : public AThrowableItem, public IUpgradableGear, public IRejoinListener {
    GENERATED_BODY()
public:
protected:
...
public:
    AGeneratorItemWithCharges(const FObjectInitializer& ObjectInitializer);
