...
protected:
    ...
    FTeamTransportState TransportState;
...
protected:
    UFUNCTION(BlueprintCallable)
    void OnRep_State(const FTeamTransportState& oldState);
    ...
    UFUNCTION(BlueprintCallable, BlueprintImplementableEvent)
    void OnAboutToLand(const float SecondsUntilLanding);
    
public:
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FVector GetTransportTargetLocation() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    EMiningPodState GetTransportState() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FVector GetTransportStartLocation() const;
